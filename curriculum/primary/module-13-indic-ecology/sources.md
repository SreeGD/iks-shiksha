# Sources — Indic Ecology — Vasudhaiva Kuṭumbakam (Primary)
...
Per the curriculum's style guide, citations must be verifiable. If a verse number, page, or attribution cannot be confirmed, the source is paraphrased without invented attribution. Where direct quotes appear in Primary-band day files, the source is identified in IAST + edition.
