...
## Fast multiplication when factors are close to 10, 100, or 1000
...
Practice the below-10 finger method (e.g., 7 × 8 using deficits).


---
## Day 2 — Two-Digit × Two-Digit Near 100 (Below)

Compute 97 × 96 using deficits.


---
## Day 3 — Two-Digit × Two-Digit Near 100 (Above)

Compute 103 × 104 using excesses.


---
## Day 4 — Mixed — One Above, One Below

Compute 102 × 98 with sign care.


---
## Day 5 — 3-Digit × 3-Digit Near 1000

Compute 997 × 996 mentally.
...
Solve problems combining ×11 and near-base methods.
...
**Personal Mental-Math Toolkit**


Each student compiles a one-page toolkit: when to use ×11, when Nikhilam multiplication, when traditional long-mult. Include 3 worked examples for each method.
