# Parent Guide — Project Implementation — Capstone (Primary)
...
This is the capstone module — your child picks a project drawing on the whole curriculum. Encourage their choice (don't pick for them). Ask them about their progress each day. Attend the share day if you can. **Safety:** pañcagavya projects in school MUST use fermented-foods comparative study (curd, paneer, batter), NOT cow-urine ingestion.
