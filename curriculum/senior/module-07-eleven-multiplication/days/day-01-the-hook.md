...
By the end of this lesson, students will: compute 23×11, 35×11 mentally using the split-and-sum method.
...
A scaled version of *Mental Math Sprint Cards* (see `activities/`). Today's slice: focus on the part of the activity that reinforces The Hook — What Is the Trick?.
