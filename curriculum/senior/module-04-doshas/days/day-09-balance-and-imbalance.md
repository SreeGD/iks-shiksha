...
By the end of this lesson, students will: distinguish prakṛti (innate) from vikṛti (current state); recognise simple imbalance signs.
...
A scaled version of *Build a Doṣa Rhythm Clock* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Balance and Imbalance.
