...
By the end of this lesson, students will: use a worksheet to estimate own dominant doṣa(s) — emphasising not diagnosis.
...
A scaled version of *Build a Doṣa Rhythm Clock* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Prakṛti Self-Assessment.
