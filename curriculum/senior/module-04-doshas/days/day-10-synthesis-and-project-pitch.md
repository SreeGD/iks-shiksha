...
By the end of this lesson, students will: pitch the 7-day self-observation project and answer assessment quiz.
...
A scaled version of *Build a Doṣa Rhythm Clock* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Synthesis and Project Pitch.
