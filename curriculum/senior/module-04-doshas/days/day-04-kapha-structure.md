...
By the end of this lesson, students will: identify kapha-style behaviours (steady, cool, moist, structured).
...
A scaled version of *Build a Doṣa Rhythm Clock* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Kapha — The Structure Principle.
