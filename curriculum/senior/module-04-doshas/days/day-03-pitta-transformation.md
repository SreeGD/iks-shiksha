...
By the end of this lesson, students will: identify pitta-style behaviours (warm, sharp, focused, transforming).
...
A scaled version of *Build a Doṣa Rhythm Clock* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Pitta — The Transformation Principle.
