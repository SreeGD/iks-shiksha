...
By the end of this lesson, students will: write a 1-page project plan: problem, sources, deliverable, deadline.
...
A scaled version of *Mid-Project Critique Circle* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Scope and Plan.
