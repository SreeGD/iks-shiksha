...
By the end of this lesson, students will: construct a tithi calendar for the current month using observation and computation.
...
A scaled version of *10-Day Moon Observation Diary* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Building a Tithi Calendar.
