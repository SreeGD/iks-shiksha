...
By the end of this lesson, students will: compare with hijri (islamic), chinese, and hebrew lunar calendars.
...
A scaled version of *10-Day Moon Observation Diary* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Cross-cultural Calendars.
