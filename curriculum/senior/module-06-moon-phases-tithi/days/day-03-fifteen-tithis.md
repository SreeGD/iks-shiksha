...
**Module:** Moon Phases and Tithi · **Band:** Senior · **Time:** 45 min

## Learning objective

By the end of this lesson, students will: recite the 15 tithi names (pratipadā, dvitīyā, ...) and explain why a tithi isn't exactly a day.
...
- *śukla pakṣa* (IAST: śukla pakṣa; lit. "waxing fortnight (new → full)")
...
A scaled version of *10-Day Moon Observation Diary* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Fifteen Tithis per Pakṣa.
