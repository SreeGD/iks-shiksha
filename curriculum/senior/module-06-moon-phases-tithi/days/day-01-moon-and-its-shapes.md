...
By the end of this lesson, students will: observe and name the four basic phases (new, first quarter, full, last quarter).
...
From *Sūrya-siddhānta (c. 5th–10th c. CE)* — see `sources.md`.
...
A scaled version of *10-Day Moon Observation Diary* (see `activities/`). Today's slice: focus on the part of the activity that reinforces The Moon and Its Shapes.
