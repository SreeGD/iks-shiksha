...
A scaled version of *Method Speed Race* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Two-Digit × Two-Digit Near 100 (Above).
