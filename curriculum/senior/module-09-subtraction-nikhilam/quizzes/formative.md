# Formative Quiz — Subtraction — Nikhilam (All from 9) (Senior)
...
3. (Multiple choice) Which day in this module focused on 'Subtract from a Power of 10'?  (a) Day 1  (b) Day 2  (c) Day 3  (d) Day 4
...
7. (Short answer) Why does the module distinguish 'Nikhilaṁ Navataścaramaṁ Daśataḥ' from related concepts? Give one example.
