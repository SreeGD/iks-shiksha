...
By the end of this lesson, students will: name the 12 rāśis in sanskrit and pair with greek zodiac names.
...
A scaled version of *Sunrise Direction Tracking* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Twelve Rāśis.
