...
**Module:** Movement of the Sun · **Band:** Senior · **Time:** 45 min

## Learning objective

By the end of this lesson, students will: observe that sunrise direction changes; introduce the ecliptic.
...
A scaled version of *Sunrise Direction Tracking* (see `activities/`). Today's slice: focus on the part of the activity that reinforces The Sun's Yearly Path.
