...
By the end of this lesson, students will: compare with egyptian, roman, gregorian.
...
A scaled version of *Sunrise Direction Tracking* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Cross-Cultural Solar Calendars.
