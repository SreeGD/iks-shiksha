...
By the end of this lesson, students will: project share + summative quiz.
...
A scaled version of *Sunrise Direction Tracking* (see `activities/`). Today's slice: focus on the part of the activity that reinforces Final Share and Assessment.
